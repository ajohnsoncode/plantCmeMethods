function combineSingChanData

% Combines data from singChan_cellSurfaceAnalysis;
...
for i = 1:noOfCells
    ...
    cellPath = strcat(folder(i).dir,'/Experiment/Condition/','cell',fileName,'_',frameGap,'/Tracking');
    cd(cellPath)
