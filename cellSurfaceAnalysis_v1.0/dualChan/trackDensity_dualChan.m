function trackDensity_dualChan(cellInfo)

% Enter an x and y value to determine the size of the ROI used to calculate
% the mean desnity of clean Tracks.  The mean is generated from frames
% middleFrame-20:middleFrame+50.
%
% AJ 08/10/2018
